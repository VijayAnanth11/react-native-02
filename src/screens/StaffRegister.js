...
const StaffRegister = ({ navigation }) => {
    ...
    const Sendtobackend = () => {
        if (fdata.name == '' ||
            ...
            fetch('http://192.168.159.210:3000/trainer', {
                method: 'POST',
                headers: {
                ...
                .then(res => res.json()).then(
                    data => {
                        ...
                        if (data.error) {
                            ...
                            alert('Staff Register successfully');
    ...
    return (
        <ImageBackground source={p13} style={styles.container}>
            ...
            <View style={styles.root}>
                <Text style={styles.sub}>Staff Registration</Text>
                {
            ...
            <TouchableOpacity style={styles.back} onPress={() => navigation.navigate("StaffManagement")}>
