...
import p4 from '../../assets/images/n3.jpg';
import p5 from '../../assets/images/n5.jpg';
...
import p10 from '../../assets/images/p12.webp';
        ...
        <ImageBackground source={cover} style={styles.container}>
            ...
            <View style={styles.body}>
                ...
                <View style={styles.itemrow}>
                    <TouchableOpacity style={styles.itembtn} onPress={() => navigation.navigate("Member")}>
                        <Image source={p4} style={styles.pic1} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.itembtn} onPress={() => navigation.navigate("Schedule")}>
                        <Image source={p5} style={styles.pic1} />
                    </TouchableOpacity>
                </View>
                <View style={styles.itemrow}>
                    <TouchableOpacity style={styles.itembtn} onPress={() => navigation.navigate("Payment")}>
                        <Image source={p6} style={styles.pic1} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.itembtn} onPress={() => navigation.navigate("Setting")}>
