...
import p4 from '../../assets/images/c2.png';
import p5 from '../../assets/images/c3.png';
        ...
        <ImageBackground source={p13} style={styles.container}>
            ...
            <View style={styles.root}>
                ...
                <View style={styles.itemrow}>
                    <TouchableOpacity style={styles.itembtn} onPress={() => navigation.navigate("StaffRegister")}>
                        <Image source={p4} style={styles.pic1} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.itembtn} onPress={() => navigation.navigate("StaffSchedule")}>
